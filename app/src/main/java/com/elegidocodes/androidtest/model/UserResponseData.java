...
public class UserResponseData {
    ...
    @SerializedName("users_has_jobs")
    @Expose
    private List<UsersHasJob> usersHasJobs;
    @SerializedName("users_has_advisors")
    @Expose
    private List<UsersHasAdvisor> usersHasAdvisors;
    @SerializedName("users_has_groups")
    @Expose
    private List<UsersHasGroup> usersHasGroups;
    @SerializedName("users_has_regions")
    @Expose
    private List<UsersHasRegion> usersHasRegions;
    ...
    public List<UsersHasJob> getUsersHasJobs() {
        return usersHasJobs;
    }

    public void setUsersHasJobs(List<UsersHasJob> usersHasJobs) {
        this.usersHasJobs = usersHasJobs;
    }

    public List<UsersHasAdvisor> getUsersHasAdvisors() {
        return usersHasAdvisors;
    }

    public void setUsersHasAdvisors(List<UsersHasAdvisor> usersHasAdvisors) {
        this.usersHasAdvisors = usersHasAdvisors;
    }

    public List<UsersHasGroup> getUsersHasGroups() {
        return usersHasGroups;
    }

    public void setUsersHasGroups(List<UsersHasGroup> usersHasGroups) {
        this.usersHasGroups = usersHasGroups;
    }

    public List<UsersHasRegion> getUsersHasRegions() {
        return usersHasRegions;
    }

    public void setUsersHasRegions(List<UsersHasRegion> usersHasRegions) {
        this.usersHasRegions = usersHasRegions;
    }
